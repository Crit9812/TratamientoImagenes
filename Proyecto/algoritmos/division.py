...
class dividir():
    ...
    def color(imagen):
        ...
        valor=simpledialog.askfloat("Valor","Ingresa el valor por el cual quieres dividir")
    ...
    def gris(imagen):
        ...
        imagenOp1= np.zeros((alto, ancho), np.uint8)
        imagenOp2= np.zeros((alto, ancho), np.uint8)
        imagenOp3= np.zeros((alto, ancho), np.uint8)
